...
public class Video_categoryService {
	 ...
	 * @param img_url
	 */
	public void update_video_img_url(int video_type_id,String img_url){
		video_categoryDao.update_video_img_url(video_type_id, img_url);
	}
	...
	public void updateAllcategoryURL(){
		...
		for (Video_category cate : list) {
			String url=cate.getVideoTypeImg();
			String suffix=url.substring(url.lastIndexOf("."));
			url=StringUtils.getUUID()+suffix;
			update_video_img_url(cate.getVideoTypeId(), url);
		}
	}
}
