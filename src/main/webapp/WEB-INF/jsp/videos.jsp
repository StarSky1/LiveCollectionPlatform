...
var vm1=new Vue({
	...
	methods: {
		search: function(){
			getVideolist(vm,vm1.logined,1,vm1.searchWord,cateName,platform);
		},
		myprofile: function(){
			if(this.logined){
  ...
  var vm=new Vue({
    ...
    methods: {
      ...
      turnPage: function(event){
        ...
        getVideolist(vm,vm1.logined,this.pageno,vm1.searchWord,cateName,platform);
      },
      prePage: function(event){
        ...
        $(".nextPage").removeClass("disabled");
        this.pageno=current;
        getVideolist(vm,vm1.logined,current,vm1.searchWord,cateName,platform);
      },
